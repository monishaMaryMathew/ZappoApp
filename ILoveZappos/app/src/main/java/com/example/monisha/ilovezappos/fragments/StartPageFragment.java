 ...
 * {@link StartPageFragment.OnStartPageFragmentInteractionListener} interface
...
public class StartPageFragment extends Fragment {
    ...
    private OnStartPageFragmentInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onStartPageFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnStartPageFragmentInteractionListener) {
            mListener = (OnStartPageFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnStartPageFragmentInteractionListener {
        // TODO: Update argument type and name
        void onStartPageFragmentInteraction(Uri uri);
    }
}
